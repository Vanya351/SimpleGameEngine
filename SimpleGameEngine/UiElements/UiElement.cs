...
public abstract class UiElement : GameObjectPrototype
{
    ...
    public UiElement(float[] position, Anchor anchor, float[] size, Color4 backgroundColor,
    ...
    /// <param name="visible">visibility of element</param>
    /// <param name="zIndex">element height index</param>
    public UiElement(float[] position, Anchor anchor, float[] size, Color4[] gradient,
    ...
    /// <param name="visible">visibility of element</param>
    /// <param name="zIndex">element height index</param>
    public UiElement(float[] position, Anchor anchor, float[] size, Texture texture,
        float rotationDegrees, bool visible = true, float zIndex = 0)
    ...
    public override void Place(float[] position, Anchor anchor, float[] size, float rotationDegrees)
    {
        position = AnchorOperations.GetTopLeft(anchor, position, size);
